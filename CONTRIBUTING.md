# Welcome to OctoProfile Plus docs contributing guide <!-- omit in toc -->
...
See [the introduction to working in the docs repository](https://github.com/wsameer/octoprofile-plus/blob/master/README.md 'README.md') to see how to install and start the development server, and navigate our codebase with confidence :confetti_ball:.
...
Scan through our [existing issues](https://github.com/wsameer/octoprofile-plus/issues) to find one that interests you. You can narrow down the search using `labels` as filters.
...
Congratulations :tada::tada: The Octoprofile Plus team thanks you :sparkles:.

Once your PR is merged, your contributions will be publicly visible on the [OctoProfile Plus Page](https://github.com/wsameer/octoprofile-plus/blob/master/README.md).
